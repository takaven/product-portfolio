...
| TKV-003 | HirePass | Recruitment Workflow | `SHORTLIST_BUILD` | `P1` | D2 critical experiences approved. D3 Pass component system is pending orchestrator/founder approval before D4 implementation. |
