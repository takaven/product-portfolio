...
| -- | ------- | -------- | ------ | -------- | -------------- |
| TKV-002 | LeaseDesk | Property Operations | `REVIVAL_IN_PROGRESS` | `P0` | Gate 3/8 D1 UX principles proposed; awaiting orchestrator/founder design decision before Gate 4/8. |
