...
| -- | ------- | -------- | ------ | -------- | -------------- |
| TKV-002 | LeaseDesk | Property Operations | `REVIVAL_IN_PROGRESS` | `P0` | Gate 2/8 completion gap audit and scope lock complete; next LeaseDesk work requires explicit Gate 3/8 authorisation. |
