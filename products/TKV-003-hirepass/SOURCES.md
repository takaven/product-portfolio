...
| ------ | ---- | ---- | -------------- | ------ | --------------- | ---------- | ------- |
| hirepass | `PRIMARY` | `GITHUB_REPOSITORY` | `VERIFIED` | main | 09ded87dbba0cff8c53a3a764608f96e03f9141b | `VERIFIED` | Founder-authorised public temporary repository containing the sanitised Talent-Flow working tree as fresh history. Sanitisation complete; old Git history intentionally not preserved. Foundation hardening PR #2 resolved the manager-form typecheck defect and established a minimal automated test baseline. |
