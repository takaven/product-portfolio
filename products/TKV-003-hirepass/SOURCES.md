...
| ------ | ---- | ---- | -------------- | ------ | --------------- | ---------- | ------- |
| hirepass | `PRIMARY` | `GITHUB_REPOSITORY` | `VERIFIED` | main | 968178eb7f9652750a1690b798404dfc4773676b | `VERIFIED` | Founder-authorised public temporary repository containing the sanitised Talent-Flow working tree as fresh history. Sanitisation complete; old Git history intentionally not preserved. HirePass product/code programme is complete through Gate 8/8; production release and deployment remain separate founder-controlled actions. |
