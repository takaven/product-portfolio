...
| ------ | ---- | ---- | -------------- | ------ | --------------- | ---------- | ------- |
| hirepass | `PRIMARY` | `GITHUB_REPOSITORY` | `VERIFIED` | main | 75b6df109a67542ee1bd7126b34c4cb758df059f | `VERIFIED` | Founder-authorised public temporary repository containing the sanitised Talent-Flow working tree as fresh history. Sanitisation complete; old Git history intentionally not preserved. HirePass product/code programme is complete through Gate 8/8, including Signature Pass enhancement, final release-quality cleanup and browser-rendered visual signature acceptance; production release and deployment remain separate founder-controlled actions. |
