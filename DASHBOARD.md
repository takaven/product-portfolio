...
| `P1` | TKV-003 | HirePass | `SHORTLIST_BUILD` | `STAGE_4_MARKET_READY_PREPARATION` | `true` | Gate 8/8 release verification complete; production deployment/release pending founder approval. |
...
| TKV-003 | HirePass | `D4_AUTHORISED` | `takaven-design-system-v1` | hirepass-visual-profile-v0 |
